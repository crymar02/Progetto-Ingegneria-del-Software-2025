...
class UserHomePageState extends State<UserHomePage> {
  ...
  // Bottone per gestire la prenotazione della visita in un click
  ...
  // Funzione per gestire il cambio di pagina (bottom bar)
  void _onItemTapped(int index) {
    setState(() => _selectedIndex = index);
    NavigationService.navigateToBottomBarPage(index);
  }

  // Funzione per costruire l'interfaccia dell'utente (homepage)
  @override
